...
# openstack image create --private  --disk-format qcow2 --container-format bare  --file ./myimages/ubuntu-16.04-sb10.3-3.img  --property key=myKey  Ubuntu-16.04-sb10.3-3
